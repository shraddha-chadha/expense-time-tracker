...
const iconTitleMap = {
  ...
  google: {
    ...
    buttonTitle: 'Enable Google Home'
  },
  ...
  utterances: {
    ...
    buttonTitle: 'Voice Assistant Features'
  },
          ...
          <Grid container className={classes.cardContainer1} >
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.linkAccount.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.addExpense.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.setBudget.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.setIncome.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.addCategory.buttonTitle}
              />
            </Grid>
          </Grid>
        </Grid>
          ...
          <Grid container className={classes.cardContainer2}>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.alexa.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.google.buttonTitle}
              />
            </Grid>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.utterances.buttonTitle}
              />
            </Grid>
          </Grid>
        </Grid>
          ...
          <Grid container className={classes.cardContainer3}>
            ...
            <Grid item>
              <ActionCard
                ...
                buttonTitle={iconTitleMap.time.buttonTitle}
              />
            </Grid>
          </Grid>
        </Grid>
